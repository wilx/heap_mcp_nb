...
public class HeapDumpTools {
    ...
    public HeapSummary loadHeap(@Required(value = "file_path", description = "Path to the .hprof heap dump file.") String filePath) throws Exception {
    ...
    public List<HeapDumpService.ClassStats> getClassesByMaxInstancesCount(
            ...
            @Default(name = "to", value = "50", description = "Zero-based end offset, exclusive.", minimum = 0) int to) {
    ...
    public List<HeapDumpService.RetainedInstance> getBiggestObjects(
            @Required(value = "limit", description = "Maximum number of retained-size-ranked objects to return.", minimum = 0) int limit) {
    ...
    public JavaClass getJavaClassByName(@Required(value = "name", description = "Fully qualified Java class name.") String name) {
    ...
    @Printer(impl = JavaClassPrinterWrapper.class)
    public JavaClass getJavaClassById(@Required(value = "id", description = "Internal Java class ID, decimal or hexadecimal.") String id) {
    ...
    public Instance getInstanceById(@Required(value = "id", description = "Internal instance ID, decimal or hexadecimal.") String id) {
    ...
    public String getInstanceRetainedSize(@Required(value = "id", description = "Internal instance ID, decimal or hexadecimal.") String id) {
    ...
    public List<HeapDumpService.ReferenceInfo> getAllReferences(
            @Required(value = "id", description = "Target internal instance ID, decimal or hexadecimal.") String id,
            @Default(name = "from", value = "0", description = "Zero-based start offset, inclusive.", minimum = 0) int from,
            @Default(name = "to", value = "50", description = "Zero-based end offset, exclusive.", minimum = 0) int to) {
    ...
    public List<JavaClass> getJavaClassesByRegExp(
            @Required(value = "regexp", description = "Regular expression matched against Java class names.") String regexp,
            @Default(name = "from", value = "0", description = "Zero-based start offset, inclusive.", minimum = 0) int from,
            @Default(name = "to", value = "50", description = "Zero-based end offset, exclusive.", minimum = 0) int to) {
    ...
    public HeapDumpService.InstancePage getInstances(
            @Required(value = "class_name", description = "Fully qualified Java class name whose instances should be listed.") String className,
            @Default(name = "from", value = "0", description = "Zero-based start offset, inclusive.", minimum = 0) int from,
            @Default(name = "to", value = "10", description = "Zero-based end offset, exclusive.", minimum = 0) int to) {
    ...
    @Tool(name = "get_duplicate_strings", title = "Get Duplicate Strings", decription = "Returns duplicate java.lang.String values with occurrence counts and associated shallow String/backing-array footprint. Sort by total_bytes or duplicate_count.")
    @Printer(impl = DuplicateStringsPagePrinter.class)
    public HeapDumpService.DuplicateStringsPage getDuplicateStrings(
            @Default(name = "sort_by", value = "total_bytes", description = "Duplicate-string sort order.", enumValues = {"total_bytes", "duplicate_count"}) String sortBy,
            @Default(name = "from", value = "0", description = "Zero-based start offset, inclusive.", minimum = 0) int from,
            @Default(name = "to", value = "50", description = "Zero-based end offset, exclusive.", minimum = 0) int to,
            @Default(name = "max_value_length", value = "200", description = "Maximum number of characters to show for each duplicate value.", minimum = 0) int maxValueLength) {
    ...
    public String executeOql(
            @Required(value = "query", description = "OQL query to execute against the loaded heap.") String query,
            @Default(name = "max_results", value = "100", description = "Maximum number of OQL rows to return.", minimum = 0) int maxResults) throws Exception {
    ...
    public List<Bm25Result> searchClasses(
            @Required(value = "query", description = "Search query for class names, fields, and superclass names.") String query,
            @Default(name = "top_n", value = "25", description = "Number of BM25 results to return.", minimum = 0) int topN,
            @Default(name = "from", value = "0", description = "Zero-based result offset.", minimum = 0) int from) {
    ...
    public String analyzeHeap(
            @Required(value = "file_path", description = "Path to the .hprof heap dump file.") String filePath,
            @Default(name = "limit", value = "10", description = "Maximum number of top classes to return.", minimum = 0) int limit) throws Exception {
